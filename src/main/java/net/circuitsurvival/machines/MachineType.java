...
public enum MachineType {
    ...
    ENTITY_DETECTOR    (Material.CALIBRATED_SCULK_SENSOR,    "エンティティ検知機",  "半径8ブロック内のエンティティを検知してRS信号を南面に出力"),
    ...
    CUSTOM_CRAFTER     (Material.CRAFTER,                  "カスタムクラフター",  "スロット0-8の3x3グリッドに中間素材を配置しRS通電で自動クラフト。複雑な部品を量産"),
